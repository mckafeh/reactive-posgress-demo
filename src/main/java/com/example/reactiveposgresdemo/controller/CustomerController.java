package com.example.reactiveposgresdemo.controller;


import com.example.reactiveposgresdemo.model.Customer;
import com.example.reactiveposgresdemo.repo.CustomerRepository;
...
public class CustomerController {
    ...
    public Mono<Customer> updateCustomer(@RequestBody Customer customer,@PathVariable Integer id){
        return repository.findById(id).map((c)-> {c.setName(customer.getName());
                return c;
